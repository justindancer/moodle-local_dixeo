...
function xmldb_local_dixeo_upgrade($oldversion) {
    ...
    if ($oldversion < 2026070604) {
        ...
        upgrade_plugin_savepoint(true, 2026070604, 'local', 'dixeo');
    }

    if ($oldversion < 2026070605) {
        ...
        upgrade_plugin_savepoint(true, 2026070605, 'local', 'dixeo');
    }
